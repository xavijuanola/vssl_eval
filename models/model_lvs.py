...
from models.models_lvs import audio_convnet
from models.models_lvs import image_convnet
from models.models_lvs import base_models
import pdb
import random
...
#         self.random_threshold = args.random_threshold
    ...
    def compute_embeddings(self, image, audio,args,mode='val'):
        # Image
        B = image.shape[0]
        self.mask = ( 1 -100 * torch.eye(B,B)).cuda()
        img = self.imgnet(image)
        ...
        return aud.squeeze(0), img.squeeze(0), A.squeeze(0).squeeze(0)
