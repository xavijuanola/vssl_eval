...
from models.resnet import ResNetSpec
from utils_dir.eval_utils import preprocess, clean_pred, extract_audio_embeddings, extract_text_embeddings
from models.resnet import BasicBlock, resnet18, ResNetSpec
...
class EZVSL(nn.Module):
    ...
    def forward(self, image, audio):
        ...
        with torch.no_grad():
            B = img.shape[0]
            Savl = logits[torch.arange(B), torch.arange(B)] * self.tau
            Savl = (Savl + 1) / 2
